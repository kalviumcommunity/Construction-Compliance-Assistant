"""
Authoritative Construction Regulatory Dataset for SiteSafe Compliance Engine.
Covers Building Codes (IBC, NEC, UPC, CBC, NYC Codes), Project Specifications,
and Inspection Reports across Electrical, Structural, Fire Safety, and Plumbing trades.
Includes dimensional compliance tables.
"""
...
REGULATORY_DOCUMENTS: List[Dict[str, Any]] = [
    ...
    # -------------------------------------------------------------
    # FIRE SAFETY TRADE (Includes IBC 705 Setback Table)
    # -------------------------------------------------------------
    {
        "id": "ibc-2021-705-setbacks",
        "doc_title": "International Building Code (IBC 2021)",
        "clause_number": "IBC Section 705.8 & Table 705.8",
        "document_type": "Code",
        "jurisdiction": "National",
        "trade": "Fire Safety",
        "page_or_section": "Chapter 7: Fire Resistance, Section 705.8 & Table 705.8",
        "content": (
            "Section 705.8 Exterior Walls Fire-Resistance Rating and Opening Protection. "
            "Exterior walls shall have fire-resistance ratings and maximum opening percentages based on fire separation distance:\n\n"
            "| Fire Separation Distance (ft) | Type V Construction (Unsprinklered) | Type V Construction (Sprinklered NFPA 13) |\n"
            "|---|---|---|\n"
            "| 0 to less than 3 ft | Not Permitted (0%) | Not Permitted (0%) |\n"
            "| 3 to less than 5 ft | Not Permitted (0%) | 15% Protected Openings |\n"
            "| 5 to less than 10 ft | 10% Protected Openings | 25% Protected Openings |\n"
            "| 10 to less than 15 ft | 15% Protected Openings | 45% Protected Openings |\n"
            "| 15 to less than 20 ft | 25% Protected Openings | 75% Protected Openings |\n"
            "| 20 ft or greater | Unlimited Openings | Unlimited Openings |\n\n"
            "Exterior openings in Type V buildings facing an interior lot line less than 5 feet away "
